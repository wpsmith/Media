<?php
/**
 * Attachment Display Settings Abstract Class
 *
 * Assists in the creation and management of adding setting to the Attachment Display Settings.
 *
...
if ( ! class_exists( 'WPS\Media\AttachmentDisplaySetting' ) ) {
	 ...
	 * @package WPS\Media
	 */
	abstract class AttachmentDisplaySetting {
		...
		private function ajax_prefilter() {
			?>
            <script>
		 ...
		 * @return array
		 */
		abstract protected function wp_prepare_attachment_for_js( $response, $attachment, $meta );
		 ...
		 * @return string
		 */
		abstract public function media_send_to_editor( $html, $send_id, $attachment );
	}
}